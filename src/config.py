...
class AppConfig:
    ...
    # high-impact bar is meaningful again. Papers resolving only via the OpenAlex
    # fallback may be undercounted, but those are rare.
    landmark_min_citations: int = 100
